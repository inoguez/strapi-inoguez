...
export interface ApiCompetitiveEdgeCompetitiveEdge
  extends Schema.CollectionType {
  collectionName: 'competitive_edges';
  info: {
    singularName: 'competitive-edge';
    pluralName: 'competitive-edges';
    displayName: 'CompetitiveEdge';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::competitive-edge.competitive-edge',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    placeholderCtaInput: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    h3Footer: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    ctaButtonFooterText: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    competitiveEdge: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    featuredWork: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiNavigationNavigation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::navigation.navigation', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWhatToBuildWhatToBuild extends Schema.CollectionType {
  collectionName: 'what_to_builds';
  info: {
    singularName: 'what-to-build';
    pluralName: 'what-to-builds';
    displayName: 'WhatToBuild';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    value: Attribute.UID<'api::what-to-build.what-to-build', 'label'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::what-to-build.what-to-build',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::competitive-edge.competitive-edge': ApiCompetitiveEdgeCompetitiveEdge;
